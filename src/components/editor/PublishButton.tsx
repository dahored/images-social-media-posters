  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content data-oc-dialog className="fixed left-1/2 top-1/2 z-50 w-full max-w-sm rounded-xl bg-surface border border-border p-5 shadow-2xl -translate-x-1/2 -translate-y-1/2">
